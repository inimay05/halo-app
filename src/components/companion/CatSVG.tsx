...
const TAIL_DUR: Record<Pose, number> = { idle: 3.0, happy: 1.8, sleepy: 5.0, excited: 1.6, sorry: 4.0 }
  ...
  return (
    <svg viewBox="0 0 120 120" width={size} height={size} overflow="visible">
      ...
      >
        ...
        >
          <path d="M75 95 Q100 110 95 85" fill="none" stroke="#E8824A" strokeWidth="7" strokeLinecap="round" />
        </motion.g>
